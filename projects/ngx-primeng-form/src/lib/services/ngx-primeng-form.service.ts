...
export class NgxPrimengFormService {
  ...
  private getNumberProperty(property: any): NgxPrimengFormNumberProperty {
    ...
    if (property) {
      ...
      // for max
      this.setProperty(model, 'prefix', property, false);
      // for max
